...
for i in range(0,lakeNum):
  ...
  #Remove partial lake images.  This is not 100% effective and needs improvement.  If you're getting empty returns try commenting this out.
